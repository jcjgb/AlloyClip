...
try {
	...
	window[e] = function(r, i, s) {
		...
		if (n.lib.Tools)
			for (var m in n.lib.Tools) this.Tools[m] = function(e) {
				return function(t) {
					return o.Tools(e, t)
				}
			}(m)
	...
	}, window[e].prototype = {set width(e) {
			this.canvas.width = e
		},
		set height(e) {
		...
		show: function(t, n, r) {
			...
			if (t)
				...
				} else t.appendChild(this.canvas);
...
})("psLib"), window.AlloyImage = window.$AI = window.psLib,
	function(e) {
			...
			return t.Matrix.prototype = {
				plus: function(e) {
					...
					for (var r = 0; r < this.m; r++)
						for (var i = 0; i < this.n; i++) n.data[r][i] = this.data[r][i] + e.data[r][i];
					return n
				},
				minus: function(e) {
		...
		window[e].module("Alteration.brightness", function(e) {
			var t = {
				process: function(e, t) {
					...
					for (var u = 0, a = n.length; u < a; u += 4)
						for (var f = 0; f < 3; f++) n[u + f] = (n[u + f] - 127.5 * (1 - r)) * o + 127.5 * (1 + r);
					return e
				}
			};
			return t
		...
		window[e].module("Alteration.gamma", function(e) {
			var t = {
				process: function(t, n) {
					...
					var a = (u + 100) / 200 * 2;
					for (var f = 0; f < s; f++)
						for (var l = 0; l < o; l++) r.xyCal(t, f, l, function(e, t, n) {
			...
			var t = {
				process: function(t, n) {
					var r = n[0],
						...
						d = 0,
						v = [i, s, o, u];
					for (var m = 0, g = t.width; m < g; m++)
						for (var y = 0, b = t.height; y < b; y++) e.lib.dorsyMath.xyCal(t, m, y, function(e, t, n) {
							var i = {
									R: e,
									G: t,
									B: n
			...
			var t = {
				process: function(t, n) {
					var r = parseInt(n[0]) || 1,
						...
						l = i * i;
					for (var c = -r; c < r; c++)
						for (var h = -r; h < r; h++) c * c + h * h > l && f.push([c, h]);
					var p = e.lib.dorsyMath.xyToIFun(o);
					for (var c = 0, d = parseInt(o / a); c < d; c++)
						for (var h = 0, v = parseInt(u / a); h < v; h++) {
			...
			var t = {
				process: function(e, t) {
					var n = parseInt(t[0]) || 3,
						...
						s = e.height,
						o = n * 2 + 1;
					for (var u = 0, a = parseInt(i / o); u < a; u++)
						for (var f = 0, l = parseInt(s / o); f < l; f++) {
							var c = [],
								h = [0, 0, 0];
							for (var p = 0; p < o; p++)
								for (var d = 0; d < o; d++) {
			...
			var t = {
				process: function(t) {
					var n = e.lib.dorsyMath,
						...
						s = t.height;
					for (var o = 0; o < i; o++)
						for (var u = 0; u < s; u++) n.xyCal(t, o, u, function(e, t, n) {
